...
class GetMovieOnAirUseCase(private val movieOnAirRepository: MovieOnAirRepository) {
    suspend fun execute() : List<MovieOnAir>? = movieOnAirRepository.getMovieOnAir()
}