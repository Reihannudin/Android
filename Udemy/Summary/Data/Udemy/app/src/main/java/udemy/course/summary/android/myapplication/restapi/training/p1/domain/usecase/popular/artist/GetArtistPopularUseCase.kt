...
class GetArtistPopularUseCase(private val artistPopularRepository: ArtistPopularRepository) {
    suspend fun execute():List<ArtistPopular>? = artistPopularRepository.getPopularArtists()
}