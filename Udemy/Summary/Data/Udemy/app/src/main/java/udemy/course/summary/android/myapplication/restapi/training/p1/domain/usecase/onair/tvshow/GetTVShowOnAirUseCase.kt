...
class GetTVShowOnAirUseCase(private val tvShowOnAirRepository: TvShowOnAirRepository) {
    suspend fun execute():List<TvShowOnAir>? = tvShowOnAirRepository.getTvShowOnAir()
}