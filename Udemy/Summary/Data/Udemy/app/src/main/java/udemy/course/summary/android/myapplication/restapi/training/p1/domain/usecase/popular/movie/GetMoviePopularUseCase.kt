...
class GetMoviePopularUseCase(private val moviePopularRepository: MoviePopularRepository) {
    suspend fun execute():List<MoviePopular>? = moviePopularRepository.getMoviesPopular()
